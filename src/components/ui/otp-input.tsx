...
const RING = {
  idle: "focus-visible:ring-2 focus-visible:ring-accent/40 focus-visible:border-accent",
  success: "border-positive focus-visible:ring-2 focus-visible:ring-positive/40",
  error: "ring-2 ring-negative/70 border-negative delay-150",
} as const;
...
const SLOT_CLASS =
  "bg-foreground/[0.04] dark:bg-white/[0.05] border border-card-border text-center font-semibold text-transparent caret-transparent outline-none transition-all duration-200 selection:bg-transparent disabled:cursor-not-allowed disabled:opacity-50";
      ...
      >
        ...
        {caretVisible && (
          <motion.span
            ...
            className={cn(
              "pointer-events-none absolute left-0 top-1/2 w-0.5 rounded-full bg-foreground",
              scale.caret
            )}
          />
        )}
